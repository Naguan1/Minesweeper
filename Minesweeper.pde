...
public void displayWinningMessage()
{
    ...
    buttons[4][1].setLabel("L");
    buttons[4][2].setLabel("M");
    buttons[4][3].setLabel("A");
    buttons[4][4].setLabel("o");
    buttons[4][5].setLabel("X");
    buttons[4][6].setLabel("D");
    buttons[4][7].setLabel("E");
    buttons[4][8].setLabel("Z");
}
